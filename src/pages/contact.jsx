...
export default function contact() {
  return (
    <div>
      ...
      <div>
        <section className="relative z-10 overflow-hidden bg-white dark:bg-dark py-20 lg:py-[120px] px-4">
          <div className="container mx-auto">
            <div className="flex flex-wrap -mx-4 lg:justify-between">
              <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div className="mb-12 max-w-[570px] lg:mb-0">
                  <div className="text-5xl font-semibold text-[#4E4E4E]">
                    Contact <span className="text-[#ffc15e]">Us</span>
                  </div>
                  <h2 className="text-dark dark:text-gray-700 py-6 text-[20px] font-bold uppercase sm:text-[30px] lg:text-[30px] xl:text-[30px]">
              ...
              <div className="w-full lg:w-1/2 xl:w-5/12 px-4">
                <div className="relative p-8 bg-[#d8b986] rounded-xl shadow-2xl dark:bg-dark-9 sm:p-12">
                  <form>
                    <div className="mb-6">
                      <input
                        type="text"
                    ...
                    <div>
                      <Button
                        type="submit"
                        className="w-full p-3 text-white transition "
                      >
                        Send Message
                      </Button>
                    </div>
